...
<body>
    <div class="container">
        ...
        <main class="form-container">
            <h2 class="page-title">Adicionar Novo Sócio</h2>
            ...
            <form action="index.php?acao=criar" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" id="nome_completo" type="text" name="nome_completo" required>
                </div>

                <div class="form-group">
                    <label for="categoria">Categoria</label>
                    <input class="form-control" id="categoria" type="text" name="categoria" required>
                </div>

                <div class="form-group">
                    <label for="contacto">Contacto</label>
                    <input class="form-control" id="contacto" type="text" name="contacto" required>
                </div>
                ...
                <button class="btn btn-success" type="submit">Guardar Sócio</button>
